...
namespace ProjEvent.Controllers
{
    public class MEMBERsController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "MEMBER_ID,NATIONAL_ID,USERNAME,PASSWORD,FNAME,LNAME,SEX,BIRTH_DATE,ADDRESS,E_MAIL,PHONE,CREDIT_CARD")] MEMBER mEMBER)
        {
